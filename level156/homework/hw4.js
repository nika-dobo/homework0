...
class ToDoList {
  constructor() {
    ...
    this.ul.innerHTML = localStorage.getItem("tasks");
  }
  ...
  listAdd() {
    ...
    icon.addEventListener("click", (e) => {
      saveInfo = localStorage.setItem("tasks", this.ul.innerHTML);
      this.count--;
    ...
    let saveInfo = localStorage.setItem("tasks", this.ul.innerHTML);
  }
}
